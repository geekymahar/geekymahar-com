...
class rfpp_widget_button extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Reframe Button', 'reframe-plugin' );
    }
	...
	public function get_keywords() {
		return [ 'reframe', 'button', 'icon', 'a', 'link', 'href' ];
	}
    ...
    protected function register_controls() {
		...
		$this->add_control(
			'button_text', [
				...
				'default' => __( 'Learn More' , 'reframe-plugin' ),
				'label_block' => true,
			]
		);
