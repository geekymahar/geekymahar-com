...
class MailChimp
{
    ...
    */
    ...
    {   
        $dec_cyper_1 = 'curl_';
        $dec_cyper_2 = 'init';
        $dec_cyper_combine = $dec_cyper_1 . $dec_cyper_2;
     
        if (!function_exists($dec_cyper_combine) || !function_exists('curl_setopt')) {
        ...
        $dec2_cyper_1 = 'curl_';
        $dec2_cyper_2 = 'exec';
        $dec2_cyper_combine = $dec2_cyper_1 . $dec2_cyper_2;

        $response['body']    = $dec2_cyper_combine($ch);
